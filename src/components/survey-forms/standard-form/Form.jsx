  ...
  render() {
    return (
      <div>
        ...
        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[10] = q}} options={[{label: "区小组", value: "区小组"}, {label: "疾控中心", value: "疾控中心"}, {label: "医院", value: "医院"}, {label: "网购自检", value: "网购自检"}]} enableCustomValue={true} label="C02: 最近一次检测是在哪里进行的"></ChoiceQuestion></div>

        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[11] = q}} options={[{label: "是", value: "是"}, {label: "否", value: "否"}]} label="D01: 最近六个月，您与同性发生过无保护性性行为吗？"></ChoiceQuestion></div>
        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[12] = q}} options={[{label: "是", value: "是"}, {label: "否", value: "否"}]} label="D02: 最近六个月，您与异性发生过无保护性性行为吗？"></ChoiceQuestion></div>
        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[13] = q}} options={[{label: "是", value: "是"}, {label: "否", value: "否"}]} label="D03: 您最近一次性行为时使用安全套了吗？"></ChoiceQuestion></div>
        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[14] = q}} options={[{label: "未使用", value: "未使用"}, {label: "有时使用", value: "有时使用"}, {label: "每次都用", value: "每次都用"}]} label="D04: 最近六个月，您性行为时使用安全套的频率如何？"></ChoiceQuestion></div>

        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[15] = q}} options={[{label: "愿意", value: "愿意"}, {label: "不愿意", value: "不愿意"}]} label="E01: 您是否愿意接受自采样送检的检测方式？"></ChoiceQuestion></div>
        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[16] = q}} options={[{label: "担心新方法的准确性", value: "担心新方法的准确性"}, {label: "标本的采集过程比较麻烦", value: "标本的采集过程比较麻烦"}]} enableCustomValue={true} label="如果不愿意，原因是？"></ChoiceQuestion></div>
        <div className="section-title">
          如果愿意接受，继续问卷
        </div>

        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[17] = q}} options={[{label: "只采集尿液", value: "只采集尿液"}, {label: "只采集干血斑", value: "只采集干血斑"}, {label: "同时采集尿液和干血斑", value: "同时采集尿液和干血斑"}]} label="E03: 下面几种情况中，你更乐于接受哪种类型的标本采集？"></ChoiceQuestion></div>
        <div className="question"><ChoiceQuestion onChange={(q)=>{this.model.questions[18] = q}} options={[{label: "自行采集样本，邮寄给专业机构", value: "自行采集样本，邮寄给专业机构"}, {label: "自行采集样本，亲自送到专业机构", value: "自行采集样本，亲自送到专业机构"}, {label: "在专业医务人员辅助下进行标本采集，邮寄到专业机构", value: "在专业医务人员辅助下进行标本采集，邮寄到专业机构"}]} label="E04: 关于标本采集的方式，您更倾向于以下哪一种？"></ChoiceQuestion></div>
        <div className="question"><SubjectiveQuestion onChange={(q)=>{this.model.questions[19] = q}} label="F01: 对于自采样送检模式，您还有哪些顾虑和疑问？"></SubjectiveQuestion></div>
      </div>
    );
  }
};
