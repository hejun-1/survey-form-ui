            ...
            <div className="row">
              <div className="col-md-12">
                <div className="wizard-card wizard-scroll-container">
                  ...
                  <p>
                    您可随时了解与本研究有关的信息资料和研究进展，如果您有与本研究有关的问题，或您在研究过程中发生了任何不适与伤害，或有关于本项研究参加者权益方面的问题，您可以通过向仁爱网发邮件与我们取得联系，仁爱网邮箱：<a href="mailto:kefu@renaijiance.com">kefu@renaijiance.com</a>。
                  </p>
                </div>
              </div>
